...
<section class="layout-row">
    <div class="layout-inner-wrapper">
        ...
        <p><a href="foobar.foo">This is a text link.</a> <a href="#">This is a visited text link</a></p>
        ...
        <fieldset>
            ...
            <div class="field-container">
                <label for="text">Number Input <abbr class="required" title="required">*</abbr></label>
        ...
        <fieldset class="options">
            <legend>Checkbox <abbr class="required" title="required">*</abbr></legend>
                <ul>
        ...
        <p>
            <a href="foobar.foo" class="button">Button</a>
            <a href="foobar.foo" class="button-hot">Hot button</a>
            <a href="foobar.foo" class="button-cool">Cool Button</a>
        </p>
...
<?php $primitives = [
    ...
    <?php } ?>
        ...
        <div class="styleguide-color bg-white fg-body-color">
            white
        </div>
    </div>
    <div class="layout-inner-wrapper">
